...
<section class="bg-gradient-to-b from-[#ECFDF5]/80 via-white to-[#F8FAFC] pt-12 pb-16 border-b border-slate-200/60 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <!-- Breadcrumbs -->
        <nav class="flex items-center justify-center gap-2 text-xs font-semibold text-[#059669] mb-4">
            <a href="{{ route('home') }}" class="hover:underline">Beranda</a>
            <span>/</span>
            <span class="text-slate-400">E-Book</span>
        </nav>
        ...
        <p class="text-[#475569] text-base sm:text-lg leading-relaxed max-w-2xl mx-auto mb-8">
        ...
        <form action="{{ route('ebook.public') }}" method="GET" class="max-w-xl mx-auto flex items-center gap-2">
            <div class="relative w-full">
                ...
                <input type="text"
                       ...
                       class="form-input pl-11 pr-4 py-3.5 shadow-sm text-sm rounded-full bg-white border border-slate-200 focus:border-[#059669]">
            </div>
        ...
        <div class="flex items-center justify-center flex-wrap gap-2 mt-6">
            <a href="{{ route('ebook.public') }}"
               class="px-4 py-1.5 rounded-full text-xs font-semibold transition-colors
                      {{ !request('q') ? 'bg-[#059669] text-white shadow-sm' : 'bg-slate-100 text-slate-600 hover:bg-[#ECFDF5] hover:text-[#059669]' }}">
                Semua E-Book
            </a>
            <a href="{{ route('ebook.public', ['q' => 'Mental']) }}"
               class="px-4 py-1.5 rounded-full text-xs font-semibold bg-slate-100 text-slate-600 hover:bg-[#ECFDF5] hover:text-[#059669] transition-colors">
                Kesehatan Mental
            </a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if(request('q'))
            <div class="mb-8 flex items-center justify-between">
                <p class="text-sm text-slate-600">
                    Menampilkan hasil pencarian untuk "<strong class="text-[#059669]">{{ request('q') }}</strong>"
                </p>
        ...
        @if($ebooks->isEmpty())
            ...
            <div class="card p-12 text-center max-w-lg mx-auto">
                ...
                <h3 class="font-sora font-bold text-lg text-[#0F172A] mb-2">E-Book Tidak Ditemukan</h3>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-7">
                ...
                <div class="card-hover overflow-hidden flex flex-col justify-between group">
                    <div>
                        ...
                        <!-- Content Details -->
                        <div class="p-5">
                            <h3 class="font-sora font-bold text-[#0F172A] text-sm mb-2 group-hover:text-[#059669] transition-colors line-clamp-2 leading-snug">
                                {{ $ebook->title }}
                            </h3>
                    ...
                    <div class="px-5 pb-5 pt-3 border-t border-slate-100 flex items-center justify-between">
                        <span class="text-[11px] font-semibold text-[#059669] bg-[#ECFDF5] px-2.5 py-1 rounded-full">Gratis</span>
                        @auth
