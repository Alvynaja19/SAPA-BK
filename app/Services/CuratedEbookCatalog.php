    ...
    public static function mentalHealthBooks(): array
    {
        return [
            [
                ...
                'is_curated' => true,
                'reader_type' => 'in_app',
                'reader_url' => 'https://static.buku.kemdikbud.go.id/content-pdf/buku-panduan-guru-bk-sma.pdf',
            ...
            [
                ...
                'is_curated' => true,
                'reader_type' => 'in_app',
                'reader_url' => 'https://ayosehat.kemkes.go.id/buku-panduan-kesehatan-jiwa-remaja',
            ...
            [
                ...
                'is_curated' => true,
                'reader_type' => 'in_app',
                'reader_url' => 'https://buku.kemdikbud.go.id/katalog/bimbingan-konseling-resiliensi',
            ...
            [
                ...
                'is_curated' => true,
                'reader_type' => 'in_app',
                'reader_url' => 'https://buku.kemdikbud.go.id/katalog/panduan-sukses-snbt-bk',
    ...
    public static function smaStudyBooks(): array
    {
        return [
            ...
            [
                ...
                'reader_url' => 'https://buku.kemdikbud.go.id/katalog/matematika-untuk-smasmk-kelas-x',
            ...
            [
                ...
                'is_curated' => true,
                'reader_type' => 'kemdikbud_sibi',
                'reader_url' => 'https://buku.kemdikbud.go.id/katalog/cerdas-cergas-berbahasa-dan-bersastra-indonesia-untuk-sma-smk-kelas-x',
                'source' => 'Kemendikbudristek SIBI',
                'language' => 'Indonesia',
                'badges' => ['Buku Resmi', 'Kelas X', 'Kurikulum Merdeka'],
            ],
            [
                ...
                'is_curated' => true,
                'reader_type' => 'kemdikbud_sibi',
                'reader_url' => 'https://buku.kemdikbud.go.id/katalog/ilmu-pengetahuan-alam-untuk-sma-kelas-x',
                'source' => 'Kemendikbudristek SIBI',
                'language' => 'Indonesia',
                'badges' => ['Buku Resmi', 'Kelas X', 'Kurikulum Merdeka'],
            ],
            [
                ...
                'is_curated' => true,
                'reader_type' => 'kemdikbud_sibi',
                'reader_url' => 'https://buku.kemdikbud.go.id/katalog/sosiologi-untuk-sma-kelas-x',
                'source' => 'Kemendikbudristek SIBI',
                'language' => 'Indonesia',
                'badges' => ['Buku Resmi', 'Kelas X', 'Kurikulum Merdeka'],
            ],
            ...
            [
                ...
                'is_curated' => true,
                'reader_type' => 'kemdikbud_sibi',
                'reader_url' => 'https://buku.kemdikbud.go.id/katalog/biologi-untuk-sma-kelas-xi',
                'source' => 'Kemendikbudristek SIBI',
                'language' => 'Indonesia',
            ...
            [
                ...
                'is_curated' => true,
                'reader_type' => 'kemdikbud_sibi',
                'reader_url' => 'https://buku.kemdikbud.go.id/katalog/fisika-untuk-sma-kelas-xi',
                'source' => 'Kemendikbudristek SIBI',
                'language' => 'Indonesia',
                'badges' => ['Buku Resmi', 'Kelas XI', 'Kurikulum Merdeka'],
            ],
            [
                ...
                'is_curated' => true,
                'reader_type' => 'kemdikbud_sibi',
                'reader_url' => 'https://buku.kemdikbud.go.id/katalog/kimia-untuk-sma-kelas-xi',
                'source' => 'Kemendikbudristek SIBI',
                'language' => 'Indonesia',
                'badges' => ['Buku Resmi', 'Kelas XI', 'Kurikulum Merdeka'],
            ],
            ...
            [
                ...
                'is_curated' => true,
                'reader_type' => 'kemdikbud_sibi',
                'reader_url' => 'https://buku.kemdikbud.go.id/katalog/matematika-untuk-smasmk-kelas-xii',
                'source' => 'Kemendikbudristek SIBI',
                'language' => 'Indonesia',
            ...
            [
                ...
                'is_curated' => true,
                'reader_type' => 'kemdikbud_sibi',
                'reader_url' => 'https://buku.kemdikbud.go.id/katalog/ekonomi-untuk-sma-kelas-xii',
                'source' => 'Kemendikbudristek SIBI',
                'language' => 'Indonesia',
                'badges' => ['Buku Resmi', 'Kelas XII', 'Kurikulum Merdeka'],
            ],
