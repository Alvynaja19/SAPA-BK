    ...
    <div class="wrap">
      <div class="foot-row">
        <div style="max-width: 320px;">
          <div class="brand-name" style="font-size: 20px; margin-bottom: 12px;">SAPA BK</div>
          <p style="font-size: 14px; color: #D2E4D6; line-height: 1.55;">
        ...
        <div class="foot-col">
          ...
          <a href="https://maps.google.com/?q=SMA+Negeri+4+Jember" target="_blank" rel="noopener noreferrer">Ruang BK, SMA Negeri 4 Jember</a>
          <a href="mailto:bk@sman4jember.sch.id">bk@sman4jember.sch.id</a>
          <a href="{{ route('about') }}">Tentang SAPA BK</a>
        </div>
      </div>
