            ...
            <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-800/40 transition-colors group">
              ...
              <td class="py-4 px-6 min-w-[360px] sm:min-w-[420px]">
                <div class="flex items-center gap-4">
                  <!-- Thumbnail Gambar (Uniform 80x56 Aspect-Cover) -->
                  <div class="w-20 h-14 min-w-[80px] max-w-[80px] rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-800 shrink-0 border border-gray-200/80 dark:border-gray-700 shadow-xs relative flex items-center justify-center">
                    @if($art->thumbnail)
                      <img
                  ...
                  <!-- Judul & Cuplikan Konten -->
                  <div class="space-y-1 min-w-0 flex-1">
                    <a
                      href="{{ route('article.detail', $art->slug) }}"
                      target="_blank"
                      class="font-bold text-sm text-gray-900 dark:text-white hover:text-brand-600 dark:hover:text-brand-400 transition-colors line-clamp-2 leading-snug block"
                      title="{{ $art->title }}"
                    >
                      {{ $art->title }}
                    </a>
                    <p class="text-xs text-gray-500 dark:text-gray-400 line-clamp-1 leading-normal">
                      {{ Str::limit(strip_tags($art->content), 95) }}
                    </p>
                  </div>
                </div>
              </td>
