            ...
            <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-800/40 transition-colors group">
              ...
              <td class="py-4 px-6 text-right whitespace-nowrap">
                <div class="inline-flex items-center gap-2 justify-end">
                  ...
                  <form method="POST" action="{{ route('bk.artikel.destroy', $art->id) }}" data-confirm="Apakah Anda yakin ingin menghapus artikel ini?" data-confirm-title="Hapus Artikel Publikasi?" data-confirm-type="danger" data-confirm-btn="Ya, Hapus Artikel">
                    @csrf
                    @method('DELETE')
                    <button
                      type="submit"
