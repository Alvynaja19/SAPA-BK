...
<div class="space-y-6">
  ...
  <div class="rounded-2xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-5 shadow-xs">
    <form method="GET" action="{{ route('bk.live-chat.riwayat') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3.5 items-end">
      
      <!-- Filter Kelas Siswa -->
      <div class="sm:col-span-1 lg:col-span-3 space-y-1.5">
        <label for="filterKelas" class="block text-xs font-bold text-gray-700 dark:text-gray-300">
          Filter Kelas Siswa
        </label>
        <select
          id="filterKelas"
      ...
      <div class="sm:col-span-1 lg:col-span-3 space-y-1.5">
        <label for="filterTanggal" class="block text-xs font-bold text-gray-700 dark:text-gray-300">
          Filter Tanggal Konseling
        </label>
        <input
          id="filterTanggal"
      ...
      <div class="sm:col-span-2 lg:col-span-4 space-y-1.5">
        <label for="filterSearch" class="block text-xs font-bold text-gray-700 dark:text-gray-300">
