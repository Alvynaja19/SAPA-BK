  ...
  <div class="h-[72px] flex items-center px-5 border-b border-gray-200/80 dark:border-gray-800 justify-between shrink-0">
    <a href="{{ $role === 'admin' ? route('admin.dashboard') : route('bk.dashboard') }}" class="flex items-center gap-3 overflow-hidden">
      ...
      <div
        ...
        :class="{
          'opacity-100 block': $store.sidebar.isExpanded || $store.sidebar.isHovered,
    ...
    <button
      ...
      class="xl:hidden h-8 w-8 rounded-lg text-gray-400 hover:text-gray-600 dark:hover:text-gray-200"
    >
      ...
      <div>
        ...
        <nav class="space-y-1">
          ...
          >
            ...
            <span :class="{ 'block': $store.sidebar.isExpanded || $store.sidebar.isHovered, 'hidden': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">Dashboard</span>
          </a>
          ...
          >
            ...
            <span :class="{ 'block': $store.sidebar.isExpanded || $store.sidebar.isHovered, 'hidden': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">Manajemen User</span>
          </a>
          ...
          >
            ...
            <span :class="{ 'block': $store.sidebar.isExpanded || $store.sidebar.isHovered, 'hidden': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">Konfigurasi AI & DB</span>
          </a>
          ...
          >
            ...
            <span :class="{ 'block': $store.sidebar.isExpanded || $store.sidebar.isHovered, 'hidden': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">System Log</span>
          </a>
          ...
          >
            ...
            <span :class="{ 'block': $store.sidebar.isExpanded || $store.sidebar.isHovered, 'hidden': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">Laporan & Statistik</span>
          </a>
        </nav>
      </div>
    @endif
      ...
      <nav class="space-y-1">
        @if($role === 'guru_bk')
          ...
          >
            ...
            <span :class="{ 'block': $store.sidebar.isExpanded || $store.sidebar.isHovered, 'hidden': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">Dashboard BK</span>
          </a>
        @endif
        ...
        >
          ...
          <span :class="{ 'block': $store.sidebar.isExpanded || $store.sidebar.isHovered, 'hidden': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">Data Siswa</span>
        </a>
        ...
        >
          ...
          <span :class="{ 'block': $store.sidebar.isExpanded || $store.sidebar.isHovered, 'hidden': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">Riwayat Chat AI</span>
        </a>
    ...
    <div>
      ...
      <nav class="space-y-1">
        ...
        >
          ...
          <span :class="{ 'block': $store.sidebar.isExpanded || $store.sidebar.isHovered, 'hidden': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">E-Book BK</span>
        </a>
        ...
        >
          ...
          <span :class="{ 'block': $store.sidebar.isExpanded || $store.sidebar.isHovered, 'hidden': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">Artikel BK</span>
        </a>
        ...
        >
          ...
          <span :class="{ 'block': $store.sidebar.isExpanded || $store.sidebar.isHovered, 'hidden': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">Knowledge Base RAG</span>
        </a>
        ...
        >
          ...
          <span :class="{ 'block': $store.sidebar.isExpanded || $store.sidebar.isHovered, 'hidden': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">Kuesioner & Tes</span>
        </a>
      </nav>
    </div>
    ...
    <div>
      ...
      <nav class="space-y-1">
        ...
        >
          ...
          <span :class="{ 'block': $store.sidebar.isExpanded || $store.sidebar.isHovered, 'hidden': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">Evaluasi Jawaban AI</span>
        </a>
        ...
        >
          ...
          <span :class="{ 'block': $store.sidebar.isExpanded || $store.sidebar.isHovered, 'hidden': !$store.sidebar.isExpanded && !$store.sidebar.isHovered }">Kelola FAQ</span>
        </a>
      </nav>
    </div>
