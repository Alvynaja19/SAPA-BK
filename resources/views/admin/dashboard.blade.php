  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-200/80 dark:border-gray-800 rounded-2xl p-5 sm:p-6 shadow-xs space-y-4 flex flex-col justify-between">
      ...
      <div class="relative w-full h-[240px] pt-2">
        <canvas id="adminAiTrendChart" class="w-full h-full"></canvas>
      </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-200/80 dark:border-gray-800 rounded-2xl p-5 sm:p-6 shadow-xs space-y-4 flex flex-col justify-between">
      ...
      <!-- Chart Canvas -->
      <div class="relative w-full h-[240px] pt-2">
        <canvas id="adminLiveTrendChart" class="w-full h-full"></canvas>
      </div>
    </div>
  ...
  function adminDashboard() {
    return {
      ...
      initCharts() {
        ...
        const aiCtx = document.getElementById('adminAiTrendChart');
        if (aiCtx) {
        ...
        const liveCtx = document.getElementById('adminLiveTrendChart');
        if (liveCtx) {
